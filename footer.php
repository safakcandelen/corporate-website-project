      ...
      <div class="container">
        <div class="row"> 
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h3 style="color:white">Serinova</h3>
            <p style="color:white">
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a style="color:white" href="blog">Ürünler</a></li>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left">
        ...
        <div style="color:white" class="credits">
          ...
          Kodlama  <a target="_blank" href="#">Şafak Can Delen</a>
        </div>
      </div>
      <div class="social-links text-center text-md-right pt-3 pt-md-0">
        ...
        <a href="<?php echo $ayarcek['ayar_youtube'] ?>" class="linkedin"><i class="bx bxl-linkedin"></i></a>
      </div>
    </div>
  </footer><!-- End Footer -->
